              ...
              <div class="card-body p-5 text-center">
                ...
                <form method="get" action="juego.php">
                  <div class="form-outline mb-4">
                    <label class="form-label" for="typeEmailX-2">Que pena !!</label>
                    <br/>
                    <label class="form-label" for="typeEmailX-2">El número era: <?php echo $nu; ?></label>
                    <br/>
                    <label class="form-label" for="typeEmailX-2">Has perdido</label>
                    </div>
